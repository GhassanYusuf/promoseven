...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fa fa-users-cog ml-2 mr-2"></i>MANAGE ENTERPRISE</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            @include('admin.widget.companies_boxes')
                                    ...
                                    @foreach ($employees as $employee)
                                        ...
                                        @if(!is_null($employee))
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <b>
                                                        <a class="text-dark" href="{{ URL('/employee/' . $employee->id) }}">{{ $employee->name }}</a>
                                                    </b>
                                                    <br>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group dropleft">
                                                        <button type="button" class="btn btn-outline-{{ $color }} dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <b>Quick Action</b>
                                                        </button>
                                                        <div class="dropdown-menu bg-white">
                                                            <a class="dropdown-item" href="{{ URL('/employee/' . $employee->id) }}"><span class="text-primary"><i class="fas fa-eye mr-1"></i>View</span></a>
